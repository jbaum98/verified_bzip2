...
(** Modified to use typeclasses instead of modules **)
...
Section Sort.
  ...
  Context {A : Type}.
  Context {leA : relation A} {L : LeDec A leA}.
  ...
  Fixpoint merge l1 l2 :=
    let fix merge_aux l2 :=
        ...
        | _, [] => l1
        | a1::l1', a2::l2' =>
          if le_dec a1 a2 then a1 :: merge l1' l2 else a2 :: merge_aux l2'
        end
    in merge_aux l2.
...
>>
  ...
  Local Notation Sorted := (LocallySorted leA) (only parsing).
  ...
  Proof.
    ...
    destruct (le_dec a a0) eqn:Heq1.
    invert H.
    simpl. constructor; trivial; rewrite Heq1; constructor.
    assert (Sorted (merge (b::l0) (a0::l2))) by (apply IHl1; auto).
    clear H0 H3 IHl1; simpl in *.
    destruct (le_dec b a0); constructor; auto || rewrite Heq1; constructor.
    invert H0.
    constructor; trivial.
    assert (Sorted (merge (a::l1) (b::l0))) by auto using IHl1.
    clear IHl2; simpl in *.
    destruct (le_dec a b); constructor; auto.
  Qed.
  ...
  Corollary LocallySorted_sort : forall l, Sorted.Sorted leA (sort l).
  ...
  Corollary StronglySorted_sort : forall l,
      Transitive leA -> StronglySorted leA (sort l).
