...
\begin{theorem}[radixsort\_correct]
  ...
  \end{equation*}
\end{theorem}
and we proved that any two stable sorts are interchangable,
...
\var{===} is used for the equivalence relation of an \var{EqDec}
instance and \var{==} for its decision procedure.
...
the function \var{rep}\footnote{Alternatively, we can say that
  $\lambda f.~\var{rep}~n~f$ is the $n$th Church numeral.} for
