...
%% \begin{proof}
%%   We reason by induction on $m$. In the inductive case, we need to show
%%   \begin{equation*}
%%     \var{PrefixSorted}~(j+1)~(\var{hdsort}~(r::m))
%%   \end{equation*}
%%   If we simplify \var{hdsort}, this becomes
%%   \begin{equation*}
%%     \var{PrefixSorted}~(j+1)~(\var{insert}_1~r~(\var{hdsort}~m))
%%   \end{equation*}
%%   where $\var{insert}_1$ is \var{insert} using the $1$-prefix
%%   lexicographic ordering used in \var{hdsort}.
%%   We know from our assumption that
%%   \begin{equation*}
%%     \var{PrefixSorted}~j~(\var{tl}~x :: \var{map}~\var{tl}~m)
%%   \end{equation*}
...
%% \end{proof}
  ...
  %% We can deconstruct $\var{insert}_1~r~(\var{hdsort}~m)$ as
  %% $m_1 \dplus r :: m_2$, where we also know that $m = m_1 \dplus m_2$.
  %% Now we have to show
  %% \begin{equation*}
  %%   \var{PrefixSorted}~(j+1)~(m_1 \dplus r :: m_2)
  %% \end{equation*}
...
We will use the function \var{combine} defined in the Coq standared
...
\begin{proof}
  ...
  \end{equation*}
  We combine these by transtivity, and then simplify, using \var{app}
